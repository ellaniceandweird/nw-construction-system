      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <Input id="currentRevisionUrl" className="mt-1.5" placeholder="Google Drive, Dropbox, or shared drive link" value={currentRevisionUrl} onChange={(e) => setCurrentRevisionUrl(e.target.value)} />
