      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <Input id="fileUrl" className="mt-1.5" placeholder="Google Drive, Dropbox, or shared drive link" value={fileUrl} onChange={(e) => setFileUrl(e.target.value)} />
            <p className="mt-1 text-xs text-muted-foreground">This is a document index, not file storage — paste a link to wherever the actual file lives.</p>
          </div>
