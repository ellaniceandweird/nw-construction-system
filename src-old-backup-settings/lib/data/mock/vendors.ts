...
export const MOCK_VENDORS: Vendor[] = [
  ...
  },
  {
    ...
    lastModifiedBy: "system", lastModifiedDate: "2026-07-01T00:00:00.000Z",
    revisionNumber: 1, module: "Procurement", status: "active",
    vendorName: "Ridgeline Roofing Crew",
    vendorCategory: "Roofing Subcontractor",
    trade: "Roofing",
    supplierType: "subcontractor",
    city: "Catskill",
    state: "NY",
    leadTimeDays: 7,
    primaryContact: "Marcus Delvecchio",
    phone: "(518) 555-0209",
    email: "marcus@ridgelineroofingcrew.com",
    website: "www.ridgelineroofingcrew.com",
    notes: "3-person crew, handles tear-off and full re-roof jobs.",
    isPreferredVendor: true,
    isApprovedVendor: true,
    performance: {
  ...
  },
  {
    ...
    lastModifiedBy: "system", lastModifiedDate: "2026-07-01T00:00:00.000Z",
    revisionNumber: 1, module: "Procurement", status: "active",
    vendorName: "Voltwright Electrical Contracting",
    vendorCategory: "Electrical Subcontractor",
    trade: "Electrical",
    supplierType: "subcontractor",
    city: "Hudson",
    state: "NY",
    leadTimeDays: 5,
    primaryContact: "Dana Ferro",
    phone: "(518) 555-0224",
    email: "dana@voltwrightelectrical.com",
    website: "www.voltwrightelectrical.com",
    notes: "Licensed electricians, used for rewiring and panel upgrades.",
    isPreferredVendor: false,
    isApprovedVendor: true,
    performance: {
