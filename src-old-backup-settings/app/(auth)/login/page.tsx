...
function LoginForm() {
  ...
  const errorMessage =
    errorParam === "wrong_domain"
      ? "That account isn't part of the Nice & Weird Group workspace. Please sign in with your @niceandweirdgroup.com account."
      ...
      <Card className="w-full max-w-sm">
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <p className="text-center text-xs text-muted-foreground">
            Restricted to Nice &amp; Weird Group Workspace accounts.
          </p>
        </CardContent>
      </Card>
    </div>
