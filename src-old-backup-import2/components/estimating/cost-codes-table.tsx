  ...
  return (
    <>
      <div className="mb-3 flex items-center justify-between gap-3">
        ...
        <Button size="sm" onClick={() => setCreating(true)} className="shrink-0"><Plus className="size-3.5" /> New Cost Code</Button>
      </div>
              ...
              <tr key={c.id} className="border-b border-border/60 last:border-0 hover:bg-accent/40">
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-1">
                    ...
                    <Button variant="ghost" size="icon" onClick={() => deleteCostCode(c.id)}><Trash2 className="size-3.5 text-destructive" /></Button>
                  </div>
                </td>
              </tr>
            ))}
