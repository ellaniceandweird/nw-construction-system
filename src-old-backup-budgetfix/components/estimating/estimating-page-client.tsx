...
const VALID_TABS = ["estimates", "takeoff", "costcodes", "costdatabase"];
  ...
  return (
    <>
      ...
      <p className="mt-4 text-xs text-muted-foreground">
        ...
        Match automatically feed Procurement&apos;s Forecast tab. Expand a project on the
        Estimates tab to see Budget vs. Actual tracking against real Purchase Orders, and
        Print Proposal for a client-facing version.
      </p>
    </>
  );
}
