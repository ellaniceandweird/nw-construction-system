...
const VALID_TABS = ["estimates", "takeoff", "costcodes"];
  ...
  return (
    <>
      ...
      <p className="mt-4 text-xs text-muted-foreground">
        Estimates and takeoff quantities shown here are illustrative — grounded in your
        real projects and real schedule activities, but your source workbook has no
        historical cost-database or takeoff records yet. Takeoff quantities tagged with
        a Forecast Material Match automatically feed Procurement&apos;s Forecast tab.
      </p>
    </>
  );
}
