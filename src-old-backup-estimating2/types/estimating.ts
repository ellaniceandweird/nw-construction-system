...
export interface TakeoffItem {
  ...
  checkedBy?: string;
  /**
   * Bridges this takeoff item to Procurement's Forecast material detector
   * (lib/forecast/material-detector.ts), e.g. "cedar-siding", "windows".
   * Optional — only needed for items the Forecast tab should pick up.
   */
  materialKey?: string;
}
