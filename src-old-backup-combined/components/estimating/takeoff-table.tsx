...
import { TakeoffPrintTable } from "@/components/estimating/takeoff-print-table";
...
export function TakeoffTable() {
  ...
  return (
    <>
      ...
      {projectIds.length === 0 && (
        <Card className="p-6 text-center text-sm text-muted-foreground print:hidden">No takeoff items yet — add one above.</Card>
      )}
