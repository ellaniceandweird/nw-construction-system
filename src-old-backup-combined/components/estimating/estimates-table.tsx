...
import { EstimatesPrintTable } from "@/components/estimating/estimates-print-table";
  ...
  return (
    <>
      <div className="mb-3 flex flex-wrap justify-end gap-2 print:hidden">
        {!expandedId && <PrintButton label="Print" />}
      ...
      {!expandedId && <EstimatesPrintTable estimates={sorted} />}
